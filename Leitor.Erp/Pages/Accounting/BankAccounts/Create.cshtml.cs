...
[Authorize(Policy = ErpPermissions.Banking.Create)]
public class CreateModel : AbpPageModel
{
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        await _bankAccountAppService.CreateAsync(BankAccount);
    ...
    private async Task LoadOptionsAsync()
    {
        ...
        if (string.IsNullOrEmpty(BankAccount.CurrencyCode))
        {
            BankAccount.CurrencyCode = currencies.FirstOrDefault(x => x.IsBaseCurrency)?.Code ?? string.Empty;
        }
    }
}
