...
namespace Leitor.Erp.Pages.Accounting.Reports.TrialBalance;
...
public class IndexModel : AbpPageModel
{
    ...
    public TrialBalanceDto Report { get; set; } = null!;

    public async Task OnGetAsync()
    {
        Report = await _reportAppService.GetTrialBalanceAsync(AsOfDate);
    }
}
