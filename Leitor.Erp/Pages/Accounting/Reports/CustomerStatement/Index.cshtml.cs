...
namespace Leitor.Erp.Pages.Accounting.Reports.CustomerStatement;
...
public class IndexModel : AbpPageModel
{
    ...
    {
        Statement = await _statementAppService.GetCustomerStatementAsync(CustomerId, FromDate, ToDate);
    }
}
